...
words = ['movie, tv, reality', 'movie, tv, reality', 'positive, joy, excitement', 'negative, fear, nervousness', 'travel, place, nature, forest', 'movie, tv, reality', 'positive, love, romantic', 'positive, joy, excitement, , , sports, ball, ballonly, soccer', 'negative, jealousy', 'travel, place, nature, mountain', 'ambiguous, sarcasm', 'negative, anger, frustration', 'negative, fear, horror', 'movie, tv, reality', 'positive, joy, pride', 'movie, tv, reality', 'positive, joy, surprise, astonished', 'movie, tv, reality', 'ambiguous, confusion', 'positive, joy, curiosity', 'positive, love, platonic', 'negative, sad, grief', 'travel, place, nature, waterbody', 'positive, joy, excitement', 'movie, tv, reality', 'negative, sad, grief', 'negative, disgust']
for word in words:
